...
const SignInPage: React.FC = () => {
  ...
  const handleSelectAccount = async (account: typeof existingAccounts[0]) => {
    setIsLoading(true);
    try {
            ...
            <GridItem>
              <VStack align="flex-start" spacing={8} pr={{ base: 0, lg: 20 }}>
                ...
                <Text fontSize="xl" color={useColorModeValue('gray.600', 'gray.300')}>
                  MoodFi is a revolutionary SocialFi platform that rewards users for sharing their daily mood through selfies.
                  Using AI-powered mood detection, users earn $NOCX tokens based on the positivity and authenticity of their vibe.
                </Text>
